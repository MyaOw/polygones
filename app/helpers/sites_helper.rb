module SitesHelper
  ...
  def create_site(site_url,site_name, user)
    ...
    #default_article  = Article.find_by(slug: "default")

    site = Site.new(user: current_user, name: site_name, url: site_url,template: default_template)
    #site.tabs << Tab.new(title: "Accueil", order: 1, item: nil)

    #Category.create(title: "Category par defaut", site: site, slug: "default")
